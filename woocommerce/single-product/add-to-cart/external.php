...
<p class="cart">
	<a href="<?php echo esc_url( $product_url ); ?>" rel="nofollow" class="single_add_to_cart_button button alt" style="background: <?php echo $product_color;?>; color: <?php echo $sec_color; ?>;"><?php echo esc_html( $add_text ); ?></a>
</p>
