...
<form class="cart" method="post" enctype='multipart/form-data'>
	...
	<?php
            ...
            // cmb2 fields
            $product_color = !empty( get_post_meta( $product->get_id(), '_selosity_product_color', true ) ) ? get_post_meta( $product->get_id(), '_selosity_product_color', true ) : $pbtheme_data['theme_color'];
            $sec_color = !empty( get_post_meta( $product->get_id(), '_selosity_product_color_sec', true ) ) ? get_post_meta( $product->get_id(), '_selosity_product_color_sec', true ) : 'white';
            $add_text = !empty( get_post_meta( $product->get_id(), '_selosity_add_cart', true ) ) ? get_post_meta( $product->get_id(), '_selosity_add_cart', true ) : $pbtheme_data['woo_addtocart'] ;
