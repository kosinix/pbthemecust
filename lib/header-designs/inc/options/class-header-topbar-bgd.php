...
/**
 * Manipulate header top bar background color
 */
class Pbtheme_Header_Topbar_Bgd implements SplObserver {
    ...
    private function set_type() {
        ...
        return isset( $pbtheme_data[ 'header_topbar_bgd_color_pattern' ] ) ? $pbtheme_data[ 'header_topbar_bgd_color_pattern' ] : 'color';
    ...
    private function set_color() {
        ...
        return isset( $pbtheme_data[ 'theme_color_top_header' ] ) ? $pbtheme_data[ 'theme_color_top_header' ] : false;
    ...
    private function set_opacity() {
        ...
        return isset( $pbtheme_data[ 'header_topbar_bgd_opacity' ] ) ? $pbtheme_data[ 'header_topbar_bgd_opacity' ] : false;
    ...
    private function set_pattern() {
        ...
        return isset( $pbtheme_data[ 'header_topbar_bgd_pattern' ] ) ? $pbtheme_data[ 'header_topbar_bgd_pattern' ] : false;
    ...
    private function set_css() {
        ...
        if ( $this->type === 'color' ) {
            ...
            return  '.header_alt_nav{background-color:' . esc_attr( $this->color ) . ';}';
