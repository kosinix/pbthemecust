...
return array(
    ...
    'header_tagline' => '<strong>Contact Us:</strong> 1 382 557 006',
    'header_tagline_alt' => 'We Create Everything Faster and Better',
    
    // Header style settings
    'header_styles_enabled' => '1',
    'header_topbar_bgd_color_pattern' => 'color',
    'theme_color_top_header' => '#82b440',
    ...
    'header_bgd_color_pattern' => 'pattern',
    'theme_color_header' => '#d3d3d3',
    'header_bgd_pattern' => get_template_directory_uri() . '/admin/assets/images/header_design/predefined_header/white_tiles.png',
    'header_link_color' => '',
    ...
    'sellocity_btn_text' => 'Your Text Here',
